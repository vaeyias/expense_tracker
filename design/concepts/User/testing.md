...
[@type-handing](../../background/type-handling.md)

[@template](../../background/test-template.md)

## MAKE THESE SPECIFIC TEST CASES:
- Test #1: Full workflow- create a user, edit displayName, delete a user

- Test #2: Duplicate Username - create a user, try to create another user with same username

- Test #3: Duplicate Display - create a user, create another user with the same displayName (this is allowed)
