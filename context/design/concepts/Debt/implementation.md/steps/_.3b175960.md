---
timestamp: 'Sun Oct 12 2025 01:32:05 GMT-0400 (Eastern Daylight Time)'
parent: '[[..\20251012_013205.fe5a3552.md]]'
content_id: 3b175960f93ea9c6c423314fe6fd362c922005cb8973a36329fbec3d12d6a18a
---
...
interface DebtRecord {
  ...
  payer: User;
  receivers: Record<User, number>; // Map of user to the amount they owe the payer for this record
...
export default class DebtConcept {
  ...
  async editDebtRecord({
    ...
    for (
      const [receiver, amountOwed] of Object.entries(existingDebtRecord)
    ) {
      if (existingDebtRecord.payer !== receiver) {
        await this.updatePersonalDebt({
          payer: receiver as User,
          receiver: existingDebtRecord.payer,
          amount: -amountOwed as number, // Subtract the old amount
        });
      }
    }
